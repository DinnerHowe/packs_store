...
"""
import rospy,serial
from sensor_msg.msg import Bumper_Event
import list_ports_linux

class cliff():
  
 def defination(self):
  self.event=Bumper_Event()
  self.pub = rospy.Publisher('/mobile_base/events/bumper', Bumper_Event, queue_size=1)
 ...
 def __init__(self,trigger=False):
  rospy.loginfo( 'building node Bumper_Event')
  rospy.init_node('Bumper_Event', anonymous=False)
